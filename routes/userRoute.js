...
const { registerUser, loginUser, logoutUser, getUser, loginStatus, updateUser, changePwd, forgotPwd, resetPwd } = require("../controllers/userController")
...
router.post("/forgotpwd", protect,  forgotPwd) //to forget pwd and get link in email
